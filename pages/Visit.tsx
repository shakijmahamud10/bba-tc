                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-24">
                    <div className="relative">
                        ...
                        <div className="relative grid grid-cols-2 gap-4">
                            <img src={IMAGES.ARTS} alt="Campus Life" className="rounded-2xl shadow-lg w-full h-64 object-cover transform translate-y-8 hover:-translate-y-2 transition-transform duration-500" />
                            <img src={IMAGES.HERO} alt="Facilities" className="rounded-2xl shadow-lg w-full h-64 object-cover hover:-translate-y-2 transition-transform duration-500" />
                        </div>
                    </div>
